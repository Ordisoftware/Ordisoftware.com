...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.ordisoftware.com/wp-content/plugins/cookie-law-info/public/js/cookie-law-info-public.js\n- Error message: "+ e.message);}
try{
...
;i++){var results=document.querySelectorAll(selectors[i].selector);var rLength=results.length;for(var r=0;r<rLength;r++){if(results[r].nodeName!='INPUT'){delayedCall(results[r],selectors[i].radii,r)}}}}})};
